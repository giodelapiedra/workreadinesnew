...
import './AdminClinicianCases.css'
...
export function AdminClinicianCases() {
  ...
  const fetchCases = useCallback(async () => {
    try {
      ...
      const result = await apiClient.get<{
        ...
        `${API_ROUTES.ADMIN.CLINICIAN_CASES}?${params}`,
  ...
  // Handle view case - navigate to case detail page (same as clinician view)
  const handleViewCase = (caseId: string) => {
    navigate(PROTECTED_ROUTES.ADMIN.CLINICIAN_CASE_DETAIL.replace(':caseId', caseId))
  }
  ...
  if (loading && cases.length === 0) {
    return (
      <DashboardLayout>
        <div className="admin-clinician-cases-container">
  ...
  return (
    <DashboardLayout>
      <div className="admin-clinician-cases-container">
        {/* Header */}
        <div className="admin-clinician-cases-header">
          <div>
            <h1 className="admin-clinician-cases-title">All Clinician Cases</h1>
            <p className="admin-clinician-cases-subtitle">View and manage all cases from clinicians</p>
          </div>
        </div>

        {/* Search and Filter Bar */}
        <div className="admin-clinician-cases-controls">
          <div className="admin-clinician-cases-search">
        ...
        {/* Error State */}
        {error && (
          <div className="admin-clinician-cases-error">
        ...
        {/* Table */}
        {cases.length === 0 ? (
          <div className="admin-clinician-cases-empty">
          ...
          <>
            <div className="admin-clinician-cases-table-wrapper">
              <table className="admin-clinician-cases-table">
                <thead>
                  <tr>
                    <th>
                      ...
                      <tr key={caseItem.id} className="table-row">
                        ...
                        <td>
                          {caseItem.clinicianName ? (
                            <span className="clinician-name" style={{ color: '#3B82F6', fontWeight: 600 }}>
                              {caseItem.clinicianName}
                            </span>
                          ) : (
                            <span className="clinician-name" style={{ color: '#94A3B8', fontStyle: 'italic' }}>
                              Not assigned
                            </span>
                          )}
                        </td>
            ...
            {/* Pagination */}
            <div className="admin-clinician-cases-pagination">
